...
var App = function () {
    ...
    var uiHandleMain = function () {
        ...
        if ($lPage.hasClass('header-navbar-fixed')) {
            ...
            $xframe.css('height', $hWindow - $hHeader - $hFooter - 5);
        } else {
    ...
    var uiHandleTheme = function () {
        var $cssTheme = $('<link rel="stylesheet" id="css-theme" href="">');
        var $theme = $.cookie.get('css-theme');

        if ($theme && $theme != 'default') jQuery('head').after($cssTheme.attr('href', $theme));
        // Set the active color theme link as active
        jQuery('[data-toggle="theme"][data-theme="' + ($theme ? $theme : 'default') + '"]')
            .parent('li')
            .addClass('active');
        ...
        jQuery('[data-toggle="theme"]').on('click', function () {
            ...
            if ($theme === 'default') {
                ...
                if ($cssTheme.length) {
                    ...
                    $cssTheme = $('<link rel="stylesheet" id="css-theme" href="">');
                }
                jQuery('head').append($cssTheme.attr('href', $theme));
            }
