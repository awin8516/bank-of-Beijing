    ...
    */
    ...
    var Editor = function (context) {
        ...
        this.createVideoNode = function (url) {
            ...
            if (ytMatch && ytMatch[1].length === 11) {
                ...
                $video = $("<div class='video-box'></div>");
                var $video2 = $('<video controls>')
                    .attr('src', url).appendTo($video);
            } else {
         ...
         * @return {Promise}
         */
        this.insertImage = function (src, param, comp) {
            comp = comp || function () { }
    ...
    var VideoDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var body = '<div class="form-group note-group-select-from-files">' +
            '<label>本地上传</label>' +
            '<input class="note-video-input form-control" type="file" name="files" accept="video/*" /></div>';

            body += '<div class="form-group row-fluid">' +
        ...
        this.createVideoNode = function (url) {
            ...
            if (ytMatch && ytMatch[1].length === 11) {
                ...
                $video = $("<div class='video-iframe'></div>");
                var $video2 = $('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                    .attr('frameborder', 0)
                    .attr('src', '//player.youku.com/embed/' + youkuMatch[1]).appendTo($video);
                    // $video.wrapAll("<div class='iframe-video'></div>")
            } else if ((qqMatch && qqMatch[1].length) || (qqMatch2 && qqMatch2[2].length)) {
                var vid = ((qqMatch && qqMatch[1].length) ? qqMatch[1] : qqMatch2[2]);
                $video = $("<div class='video-iframe'></div>");
                var $video2 = $('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                    .attr('frameborder', 0)
                    .attr('src', 'http://v.qq.com/iframe/player.html?vid=' + vid + '&amp;auto=0').appendTo($video);
            } else if (mp4Match || oggMatch || webmMatch) {
                $video = $("<div class='video-box'></div>");
                var $video2 = $('<video controls>')
                    .attr('src', url).appendTo($video);
