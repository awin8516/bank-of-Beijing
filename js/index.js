...
window.onload = function() {
  ...
  function createPeoplePopHtml(pe) {
    var html =
      ...
      ".jpg'>\
        <div>";
    pe["姓名"].trim() != "/" && (html += "<h2><b>姓名：</b>" + pe["姓名"] + "</h2>");
    pe["工号"].trim() != "/" && (html += "<h2><b>工号：</b>" + pe["工号"] + "</h2>");
    pe["岗位"].trim() != "/" && (html += "<h2><b>岗位：</b>" + pe["岗位"] + "</h2>");
    pe["服务承诺"].trim() != "/" && (html += "<h2><b>服务承诺：</b>" + pe["服务承诺"] + "</h2>");
    pe["销售资质"].trim() != "/" && (html += "<h2><b>销售资质：</b>" + pe["销售资质"] + "</h2>");
    html += "</div></div>";
    try {
