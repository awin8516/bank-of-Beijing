Swiper.prototype.plugins.scrollbar = function(a, b) {
    ...
    function d() {
        u.style.width = "",
        u.style.height = "",
        s ? (h = a.h.getWidth(t, !0), b.dragSize && b.dragSize > 0 ? (l = b.dragSize, n = h - l, p = a.h.getWidth(a.wrapper) + a.wrapperLeft + a.wrapperRight - a.width, k = n / p) : 
		(j = a.width / (a.h.getWidth(a.wrapper) + a.wrapperLeft + a.wrapperRight), k = j * (h / a.width), l = h * j), u.style.width = l + "px") : 
		(i = a.h.getHeight(t, !0), b.dragSize && b.dragSize > 0 ? (m = b.dragSize, o = i - m, q = a.h.getHeight(a.wrapper) + a.wrapperTop + a.wrapperBottom - a.height, k = o / q) : 
		(j = a.height / (a.h.getHeight(a.wrapper) + a.wrapperTop + a.wrapperBottom), k = j * (i / a.height), m = i * j), m > i && (m = i), u.style.height = m + "px")
    ...
    if (e) {
        ...
        if ((document.querySelectorAll || window.jQuery) && (b.container.nodeType || 0 !== c(b.container).length)) {
            var h, i, j, k, l, m, n, o, p, q, r = b.container.nodeType ? b.container: c(b.container)[0],
            s = "horizontal" === a.params.mode,
            t = r,
            u = document.createElement("div");
            u.className = "swiper-scrollbar-drag",
            b.draggable && (u.className += " swiper-scrollbar-cursor-drag"),
            /* 追加修改成替换防止生成两个或多个bar start */
            t.childNodes.length>0?t.removeChild(t.childNodes[0]):null,
			/* 追加修改成替换防止生成两个或多个bar end */
            t.appendChild(u),
            b.hide && (t.style.opacity = 0);

            /* 修复 simulateTouch：false 时同时禁掉了滚动条move事件的BUG */
            var desktopEvents = ['mousedown', 'mousemove', 'mouseup'];
            a.touchEvents = {
                touchStart: a.support.touch
                /*|| !params.simulateTouch*/
                ? 'touchstart': desktopEvents[0],
                touchMove: a.support.touch
                /*|| !params.simulateTouch*/
                ? 'touchmove': desktopEvents[1],
                touchEnd: a.support.touch
                /*|| !params.simulateTouch*/
            ...
            if (b.draggable) {
                ...
                v = function(c) {
					...
					isDrag = target.className.indexOf('swiper-scrollbar-drag') != -1 ? true : false;
					uh = false;
                    A = !0,
                ...
                y = function(b) {
                    ...
                    if (s) {
						...
						/* 修复点击bar时会跳一下的BUG，原程序是必须点击bar中点 start */
						uh = isDrag ? uh || e - a.h.getOffset(t).left - (a.getTranslate(u).x || 0) : l/2
						/* 修复点击bar时会跳一下的BUG，原程序是必须点击bar中点 end */
                        c = e- a.h.getOffset(t).left - uh
                        0 > c ? c = 0 : c + l > h && (c = h - l)
                    } else {
                        var f = "touchstart" === b.type || "touchmove" === b.type ? b.targetTouches[0].pageY: b.pageY || b.clientY;
                        /* 修复点击bar时会跳一下的BUG，原程序是必须点击bar中点 start */
						uh = isDrag ? uh || f - a.h.getOffset(t).top - (a.getTranslate(u).y || 0) : m/2
						/* 修复点击bar时会跳一下的BUG，原程序是必须点击bar中点 end */
						d = f - a.h.getOffset(t).top - uh
                        0 > d ? d = 0 : d + m > i && (d = i - m)
                    }
                    a.setTranslate(u, {
                        x: c,
